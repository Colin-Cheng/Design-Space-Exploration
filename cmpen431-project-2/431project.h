...
const std::string GLOB_baseline="0 0 0 5 0 5 0 2 2 2 0 3 0 1 2 0 0 3";
const std::string GLOB_dimensionnames[NUM_DIMS]={
	"width", 
	"scheduling",
	"l1block", 
	"dl1sets", 
	...
	"il1lat", 
	"ul2lat"};
const unsigned int GLOB_dimensioncardinality[NUM_DIMS]={4,2,4,9,3,9,3,10,4,5,3,5,5,4,5,10,10,10};
const std::string GLOB_fields[7]={
	"sim_num_insn ",
	"sim_cycle ",
	"il1.accesses ",
	"dl1.accesses ",
