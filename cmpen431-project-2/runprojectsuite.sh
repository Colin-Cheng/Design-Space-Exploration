...
"/home/software/simplesim/ss-benchmark/milc/milc_base.i386-m32-gcc42-nn < /home/software/simplesim/ss-benchmark/milc/su3imp.in")
...
# Number of sets in TLBs (both DTLB and ITLB)
...
for benchnum in $(seq 0 $((${#benchpairs[*]} - 1))) ; do
    eval /home/software/simplescalar/x86_64/bin/sim-outorder -fastfwd 5000000 -max:inst 100000 \
        ...
        -res:memport 1 \
        -res:fpalu ${width[$width_index]} \
        -res:fpmult ${width[$width_index]} \
        ...
        -tlb:itlb itlb:${tlbsets[$tlbsets_index]}:4096:4:${replacepolicy[$replacepolicy_index]} \
        -tlb:dtlb dtlb:${tlbsets[$tlbsets_index]}:4096:4:${replacepolicy[$replacepolicy_index]} \
